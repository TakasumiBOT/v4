...
export type stockWhereInput = {
  ...
  index?: Prisma.IntFilter<"stock"> | number
  updateAt?: Prisma.DateTimeFilter<"stock"> | Date | string
}
...
export type stockScalarWhereWithAggregatesInput = {
  ...
  index?: Prisma.IntWithAggregatesFilter<"stock"> | number
  updateAt?: Prisma.DateTimeWithAggregatesFilter<"stock"> | Date | string
}
...
export type stockOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"companyId" | "index" | "updateAt", ExtArgs["result"]["stock"]>
...
export interface stockDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const stockWithCompanyIdOnly = await prisma.stock.findMany({ select: { companyId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Stocks and only return the `companyId`
   * const stockWithCompanyIdOnly = await prisma.stock.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Stocks and only return the `companyId`
   * const stockWithCompanyIdOnly = await prisma.stock.updateManyAndReturn({
   *   select: { companyId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface stockFieldRefs {
  ...
  readonly index: Prisma.FieldRef<"stock", 'Int'>
  readonly updateAt: Prisma.FieldRef<"stock", 'DateTime'>
}
