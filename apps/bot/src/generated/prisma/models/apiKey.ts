...
export type apiKeyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "token" | "permission" | "createdAt", ExtArgs["result"]["apiKey"]>
...
export interface apiKeyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const apiKeyWithUserIdOnly = await prisma.apiKey.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ApiKeys and only return the `userId`
   * const apiKeyWithUserIdOnly = await prisma.apiKey.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ApiKeys and only return the `userId`
   * const apiKeyWithUserIdOnly = await prisma.apiKey.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
